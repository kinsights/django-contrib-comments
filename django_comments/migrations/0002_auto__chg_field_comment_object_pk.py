...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.execute('ALTER TABLE "django_comments" ALTER COLUMN "object_pk" TYPE integer USING (trim("object_pk")::integer);')
        db.alter_column('django_comments', 'object_pk', self.gf('django.db.models.fields.PositiveIntegerField')())
